...
//key - lenght: 16 , hex
	...
	public class Des {
           public static ArrayList<String> weakey = new ArrayList<>(Arrays.asList("0101010101010101" , "1F1F1F1F0E0E0E0E" , "E0E0F1F1F1F1","FEFEFEFEFEFEFEFE"));
	        ...
	        String sBox(String input)
	        {
	            ...
	            for (int i = 0; i < 48; i += 6) {
	                ...
	                output += Integer.toHexString(
	                    sbox[num][row][col]);//return 4 bits each s box
	            }
	            return output;
	        }
	        ...
	        public static  String hexToString(String hexStr)
	        {
	        	char ch1;
	 	        ...
	 	        for(int i = 0; i < charArray.length; i=i+2) {
	 	          ...
	 	          ch1 = (char)Integer.parseInt(st, 16);
	 	        	 }
	 	           result1 = result1 + ch1;
	 	        }
	 	        return result1;
	    ...
	    public static String Encryption(String input , String key)
	    {
	        ...
	        text1= stringToHex(input);

	        Des cipher = new Des();
	        System.out.println("Encryption:\n");
	        
	        for(int i=0;i<text1.length();i=i+16)
	        {
	        text=text1.substring(i,i+16);
	          ...
	          for(int i=0;i<cipherText.length();i=i+16)
		        {
	        	  ...
	        	  finalText += cipher.decrypt(temp, Key);
	  	      
		        }
	          
	  	     System.out.println("\nPlain Text: "+ finalText.toUpperCase());
	  	     finalText = hexToString(finalText);
	  	     return  finalText;
		    }
